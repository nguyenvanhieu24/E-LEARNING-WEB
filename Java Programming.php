...
68320 students </div>
<div class="container1" style="margin-right: 1000px;">
...
<p class="title-wrap__desc" title="Tutorial to help you self-study Java programming from basic to advanced (Designed specifically for beginners). After completed, help you prepare for web programming and android programming."><li>Tutorial to help you self-study Java programming from basic to advanced (Designed specifically for beginners). After completed, help you prepare for web programming and android programming.</li></p>
...
<ul>
<li>Understand the usage of Java language:</li><br>
...
<li>Install software JDK or Eclipse.</li>
</ul>
</ul>
  </div>
  ...
  <div id="samples" class="panel1">
    <div class="content">
        <div class="review1">
      <h3><strong>&nbsp;Overview of Java language:</strong></h3>
      <p><ul>
        <div class="video-review1" style="text-align:center;padding-bottom: 10px;">
            <iframe width="700" height="360" src="https://www.youtube.com/embed/3gtOAlcovoQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
<li>Java (Vietnamese pronunciation: "Java") is a class-based, object-oriented programming language designed to have as few implementation dependencies as possible.</li>
<li>It is a general-purpose programming language that allows developers to write once, run anywhere (WORA), which means compiled Java code can run on all Java-enabled platforms without no need to recompile.</li>
<li>Java applications are typically compiled to bytecode that can run on any Java virtual machine (JVM) regardless of the underlying computer architecture.</li>
<li>Java's syntax is similar to C and C++, but has less low-level facilities than the above languages.</li>
<li>The Java runtime provides dynamic capabilities (such as reflection and modification of runtime code) that are not normally available in traditional compiled languages.</li>
<p>
<li>As of 2019 Java is one of the most popular programming languages ​​used according to GitHub, especially for client-server web applications, with 9 million developers reported.
</li>
</p>
</ul></p>
<h3><strong>Application of Java language:</strong></h3>
<p><ul>
  ...
  <div id="offers" class="panel1">
    <div class="content" style="margin-top: 55px;">
      <p><div class="dropdown">
        <button onclick="hamDropdown()" class="nut_dropdown" style="background: linear-gradient(to right,#0cd1e8,#ff78f8);box-shadow: 0px 8px 16px 0px red;"><h3>List Lesson - Java Language</h3></button></div>
        <div class="noidung_dropdown">
            <div class="noidung_dropdown1">
            <ul style="list-style-image: url('images/coding1.png');margin-right: 10px;">
                <li><a href="http://localhost:8080/Together2/course Java Programming.php#home">Lesson 1 - Introduction to Java<h5 style= "float:right; flex-shrink: 0; margin-left: 58px; min-width: 69px;margin-top: 25px ">00:09:11</h5></a></li>
                <li><a href="http://localhost:8080/Together2/course Java Programming.php#samples">Lesson 2 - Java environment settings<h5 style= "float:right; flex-shrink: 0; margin-left: 58px; min-width: 69px;margin-top: 25px ">00:14:21</h5></a></li>
                <li><a href="http://localhost:8080/Together2/course Java Programming.php#offers">Lesson 3 - First Java program<h5 style= "float:right; flex-shrink: 0; margin-left: 58px; min-width: 69px;margin-top: 25px ">00:09:59</h5></a></li>
                <li><a href="http://localhost:8080/Together2/course Java Programming.php#product">Lesson 4 - Variables in Java<h5 style= "float:right; flex-shrink: 0; margin-left: 58px; min-width: 69px;margin-top: 25px ">00:15:09</h5></a></li>
                <li><a href="http://localhost:8080/Together2/course Java Programming.php#contact">Lesson 5 - Data types in Java<h5 style= "float:right; flex-shrink: 0; margin-left: 58px; min-width: 69px;margin-top: 25px ">00:9:32</h5></a></li>
                <li><a href="#">Lesson 6 - Operator in Java<h5 style= "float:right; flex-shrink: 0; margin-left: 58px; min-width: 69px;margin-top: 25px ">00:11:16</h5></a></li>
                <li><a href="#">Lesson 7 - Constants in Java<h5 style= "float:right; flex-shrink: 0; margin-left: 58px; min-width: 69px;margin-top: 25px ">00:08:03</h5></a></li>
                <li><a href="#">Lesson 8 - Cast in Java<h5 style= "float:right; flex-shrink: 0; margin-left: 58px; min-width: 69px;margin-top: 25px ">00:11:37</h5></a></li>
                <li><a href="#">Lesson 9 - Branching structure in Java<h5 style= "float:right; flex-shrink: 0; margin-left: 58px; min-width: 69px;margin-top: 25px ">00:12:58</h5></a></li>
                <li><a href="#">Lesson 10 - While loop in Java<h5 style= "float:right; flex-shrink: 0; margin-left: 58px; min-width: 69px;margin-top: 25px ">00:09:05</h5></a></li>
            </ul>
        </div>
    </div></p>
</div>
                        ...
                        <ul class="list-key-features">
                            <li>
                               <div class="heading-key" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <p class="key-des"><h1>Please complete the Java Language Quiz below</h1></p>
                            </div></li>
                        </ul></div>

<p><iframe src="https://together.h5p.com/content/1291623426089218769/embed" aria-label="Java Lesson" width="1088" height="637" frameborder="0" allowfullscreen="allowfullscreen" allow="autoplay *; geolocation *; microphone *; camera *; midi *; encrypted-media *"></iframe><script src="https://together.h5p.com/js/h5p-resizer.js" charset="UTF-8"></script></p>
<div class="popup-box">
      <div class="popup">
    ...
    <ul id="navigation" style="float:right;">
      ...
      <?php  
        if (isset($_SESSION['username']) || isset($_SESSION['login_id'])){
            ...
            echo "<li onclick='plslogin()'><a id='link-contact' href='#' class='button-1' style='margin-top: 420px; float: left;margin-left:70px'><p style='text-align:center;cursor:not-allowed;' title=><b>Multiple-choice</b></p></a></li>";
        }
      ?>
</div>
</main>
