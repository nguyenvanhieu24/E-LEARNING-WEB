...
<head>
  ...
  <script type="text/javascript">
    ...
    function courseJavaProgramming (){
        location.href="course Java Programming.php";
    }
	...
	<title>course Java Programming</title>
</head>
...
<section class="sidebar close">
    <div class="logo-details">
      <i><a title="Java Programming" onclick=" JavaProgramming()" style="cursor:pointer;"><img alt="SQl" class="bx bxl-c-plus-plus" src="images/java.png" style="cursor: pointer;"></a></i>
      <span class="logo_name">Java Programming</span>
    </div>
    <ul class="nav-links">
      <li>
        <a href="#">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a id="link-contact" href="http://localhost:8080/Together2/Java%20Programming.php#contact">Multiple-Choice</a></li>
        </ul>
      </li>
      <li>
        <a href="#">
  ...
  <div id="home" class="content">
    <h3 style="font-family: codelearn-font;">
        <strong>Lesson 1 - Introduction to Java</strong>
    </h3>
    <center>
    <section class="course1_C">
        <iframe width="850" height="482" src="https://www.youtube.com/embed/3gtOAlcovoQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </section></center>
    <hr>
    ...
    <section class="list-lesson" style="float:right;">
        <ul style="list-style-image: url('images/coding1.png');margin-right: 10px;">
            ...
            <li><a href="#home">Lesson 1 - Introduction to Java</a></li>
            <li><a href="#samples">Lesson 2 - Java environment settings</a></li>
            <li><a href="#offers">Lesson 3 - First Java program</a></li>
            <li><a href="#product">Lesson 4 - Variables in Java</a></li>
            <li><a href="#contact">Lesson 5 - Data types in Java</a></li>
            <li><a href="#">Lesson 6 - Operator in Java</a></li>
            <li><a href="#">Lesson 7 - Constants in Java</a></li>
            <li><a href="#">Lesson 8 - Cast in Java</a></li>
            <li><a href="#">Lesson 9 - Branching structure in Java</a></li>
            <li><a href="#">Lesson 10 - While loop in Java</a></li>
        </ul>
    </section>
    <br>
    <br>
    ...
    <section class="button-NB" style="margin-top: 300px;margin-left: 550px;">
        ...
        <button class="snip1582" style="margin: 0px;box-shadow: 0px 8px 16px 0px red;"><a href="http://localhost:8080/Together2/course Java Programming.php#home"><i class="fa-solid fa-list"></i></a></button>
    ...
    <div class="content">
        <h3><strong>Lesson 2 - Java environment settings</strong></h3>
        <section class="course1_C2">
        <iframe width="800" height="482" src="https://www.youtube.com/embed/KjMRn1YQcLc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </section>
        <hr>
    ...
    <section class="button-NB" style="margin-top: 300px;margin-left: 340px;">
        ...
        <button class="snip1582" style="margin: 0px;"><a href="http://localhost:8080/Together2/course Java Programming.php#home"><i class="fa-solid fa-list"></i></a></button>
...
<div id="offers" class="panel">
    <div class="content">
      <h3>Lesson 3 - First Java program</h3>
      <section class="course1_C2">
          <iframe width="800" height="482" src="https://www.youtube.com/embed/jIQmebw9VaA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </section>
      <hr>
      <div class="col-xs-12 col-sm-7 col-md-6" style="float:right; margin-right: -300px; margin-top: -540px;" data-aos="fade-up" data-aos-duration="1000">
                        <ul class="list-key-features">
...
<section class="list-lesson" style="float:right;">
  ...
  <div id="product" class="panel">
    <div class="content">
      <h3>Lesson 4 - Variables in Java</h3>
      <section class="course1_C2">
          <iframe width="800" height="482" src="https://www.youtube.com/embed/G2mCSTtBojM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </section>
       <hr>
      <div class="col-xs-12 col-sm-7 col-md-6" style="float:right; margin-right: -300px; margin-top: -540px;" data-aos="fade-up" data-aos-duration="1000">
                        <ul class="list-key-features">
  ...
  <div id="contact" class="panel">
    <div class="content">
        <h3>Lesson 5 - Data types in Java</h3>
        <section class="course1_C2">
            <iframe width="800" height="482" src="https://www.youtube.com/embed/4k_5vWY2wps" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </section>
        <hr>
      <div class="col-xs-12 col-sm-7 col-md-6" style="float:right; margin-right: -300px; margin-top: -540px;" data-aos="fade-up" data-aos-duration="1000">
                        <ul class="list-key-features">
