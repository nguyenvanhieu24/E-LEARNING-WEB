...
<head>
  ...
  <script type="text/javascript">
    ...
    function course_SQL_langquage(){
        location.href="course_SQL_language.php";
    }
    function Learning(){
	...
	<title>Course SQL Language</title>
</head>
                                ...
                                <div class="wrap-right-headers">
                                       <nav class="site-menu">
                                        <ul class="menu menu-main-menu">
                                            ...
                                            <li class="current">
                                                <a title="Learning" onclick="Learning()">Learning</a>
                                            </li>
                                            <li>
...
<section class="sidebar close">
    <div class="logo-details">
      <i><a title="Structured Query Language" onclick=" IntroductiontoSQL()" style="cursor:pointer;"><img alt="SQl" class="bx bxl-c-plus-plus" src="images/sql-server1.png" style="cursor: pointer;"></a></i>
      <span class="logo_name"><center>Structured Query Language</center></span>
    </div>
    <ul class="nav-links">
      <li>
        <a href="#">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a id="link-contact" href="http://localhost:8080/Together2/Introduction%20to%20SQL.php#contact">Multiple-Choice</a></li>
        </ul>
      </li>
      <li>
        <a href="#">
  ...
  <div id="home" class="content">
    <h3 style="font-family: codelearn-font;">
        <strong>Lesson 1 - Basic SQL - SELECT FROM WHERE</strong>
    </h3>
    <center>
    <section class="course1_C">
        <iframe width="850" height="482" src="https://www.youtube.com/embed/FUotBX7zNs8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>            
    </section></center>
    <hr>
      <div class="col-xs-12 col-sm-7 col-md-6" style="float:right; margin-right: -400px; margin-top: -540px;" data-aos="fade-up" data-aos-duration="1000">
    ...
    <div class="wrapper" style="float:right; margin-right: -392px; margin-top: -350px;" data-aos="fade-up" data-aos-duration="1000">
      <li class="add-box">
    ...
    <section class="list-lesson" style="float:right;">
        <ul style="list-style-image: url('images/coding1.png');margin-right: 10px;">
            <h3 style="text-align: center;color: #c53f3a;">Lesson list</h3>
                <li><a href="#home">Lesson 1 - Basic SQL - SELECT FROM WHERE</a></li>
                <li><a href="#samples">Lesson 2 -  Basic SQL - Learn about SUM COUNT GROUP BY</a></li>
                <li><a href="#offers">Lesson 3 - Basic SQL - Learn about CASE WHEN</a></li>
                <li><a href="#product">Lesson 4 - Basic SQL - Handling Complex SQL with WITH (CTE)</a></li>
                <li><a href="#contact">Lesson 5 - Basic SQL - Handling DateTime Timestamp SQL</a></li>
                <li><a href="#lesson6">Lesson 6 - Basic SQL - Learn about SQL LEFT JOIN to process multiple tables</a></li>
                <li><a href="#lesson7">Lesson 7 - Basic SQL - Must-know SQL syntaxes</a></li>
        </ul>
    </section>
    <br>
    <br>
    ...
    <section class="button-NB" style="margin-top: 300px;margin-left: 550px;">
        ...
        <button class="snip1582" style="margin: 0px;box-shadow: 0px 8px 16px 0px red;"><a href="http://localhost:8080/Together2/course_SQL_language.php#home"><i class="fa-solid fa-list"></i></a></button>
    ...
    <div class="content">
        <h3><strong>Lesson 2 -  Basic SQL - Learn about SUM COUNT GROUP BY </strong></h3>
        <section class="course1_C2">
            <iframe width="850" height="482" src="https://www.youtube.com/embed/9mYjH5Gw3_k?list=PL01fPqVNMdrmtcb_Yui_Oh23X_3laoZoO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </section>
        <hr>
    ...
    <section class="button-NB" style="margin-top: 300px;margin-left: 340px;">
        ...
        <button class="snip1582" style="margin: 0px;"><a href="http://localhost:8080/Together2/course_SQL_language.php#home"><i class="fa-solid fa-list"></i></a></button>
...
<div id="offers" class="panel">
    <div class="content">
      <h3>Lesson 3 - Basic SQL - Learn about CASE WHEN</h3>
      <section class="course1_C2">
        <iframe width="850" height="482" src="https://www.youtube.com/embed/inHTadgmMdY?list=PL01fPqVNMdrmtcb_Yui_Oh23X_3laoZoO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </section>
      <hr>
      <div class="col-xs-12 col-sm-7 col-md-6" style="float:right; margin-right: -300px; margin-top: -540px;" data-aos="fade-up" data-aos-duration="1000">
                        <ul class="list-key-features">
...
<section class="list-lesson" style="float:right;">
  ...
  <div id="product" class="panel">
    <div class="content">
      <h3>Lesson 4 - Basic SQL - Handling Complex SQL with WITH (CTE)</h3>
      <section class="course1_C2">
        <iframe width="850" height="482" src="https://www.youtube.com/embed/yXtOdRDl8GQ?list=PL01fPqVNMdrmtcb_Yui_Oh23X_3laoZoO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </section>
       <hr>
      <div class="col-xs-12 col-sm-7 col-md-6" style="float:right; margin-right: -300px; margin-top: -540px;" data-aos="fade-up" data-aos-duration="1000">
                        <ul class="list-key-features">
  ...
  <div id="contact" class="panel">
    <div class="content">
        <h3>Lesson 5 - Basic SQL - Handling DateTime Timestamp SQL</h3>
        <section class="course1_C2">
            <iframe width="850" height="482" src="https://www.youtube.com/embed/RPDU13sXGEU?list=PL01fPqVNMdrmtcb_Yui_Oh23X_3laoZoO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </section>
        <hr>
      <div class="col-xs-12 col-sm-7 col-md-6" style="float:right; margin-right: -300px; margin-top: -540px;" data-aos="fade-up" data-aos-duration="1000">
                        <ul class="list-key-features">
...
<div id="lesson6" class="panel">
    <div class="content">
      <h3>Lesson 6 - Basic SQL - Learn about SQL LEFT JOIN to process multiple tables</h3>
      <section class="course1_C2">
        <iframe width="850" height="482" src="https://www.youtube.com/embed/k7UI0E-n198?list=PL01fPqVNMdrmtcb_Yui_Oh23X_3laoZoO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </section>
      <hr>
      <div class="col-xs-12 col-sm-7 col-md-6" style="float:right; margin-right: -300px; margin-top: -540px;" data-aos="fade-up" data-aos-duration="1000">
                        <ul class="list-key-features">
...
<div id="lesson7" class="panel">
    <div class="content">
      <h3>Lesson 7 - Basic SQL - Must-know SQL syntaxes</h3>
      <section class="course1_C2">
        <iframe width="850" height="482" src="https://www.youtube.com/embed/YeEwrECWvCQ?list=PL01fPqVNMdrmtcb_Yui_Oh23X_3laoZoO" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      </section>
      <hr>
      <div class="col-xs-12 col-sm-7 col-md-6" style="float:right; margin-right: -300px; margin-top: -540px;" data-aos="fade-up" data-aos-duration="1000">
                        <ul class="list-key-features">
